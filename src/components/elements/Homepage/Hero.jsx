                ...
                <div className="container text-primary-0 py-8 lg:py-24 flex items-center gap-x-20">
                    <div className="lg:mr-20">
                        ...
                        <div className="text-Secondinary-200 text-Regular-12 flex gap-x-5">
                            <p className="flex gap-x-2 items-center"><FaCircleCheck className="text-primary-300"/>Get free trial for 7 days</p>
                            <p className="flex gap-x-2 items-center"><FaCircleCheck className="text-primary-300"/>Competitive Pricing plan</p>
                        </div>
                    </div>

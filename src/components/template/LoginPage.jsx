        ...
        <div className='flex lg:flex-row-reverse flex-col lg:justify-between items-center gap-y-6'>
            <div className='flex flex-col gap-y-12 mx-auto mt-8 lg:mt-0' >
                <div className=''>
                    ...
                    <h1 className='my-6 lg:my-8 text-Bold-24 lg:text-Bold-32'>Let’s login to your account first</h1>
                    ...
                    <div className='flex justify-between items-center text-Semibold-14 lg:text-Semibold-16'>
                        <div className='flex items-center gap-x-2'>
                            <input type='checkbox'/>
                            <label>Reember me</label>
                        </div>
                        <p className='text-primary-400 hover:text-primary-600'>Forgot Password</p>
                    </div>
                    <button className='bg-pr bg-primary-500 my-6 lg:my-8 py-4 rounded-xl w-full text-Bold-14 text-primary-0'>Login</button>
                    <p className='w-full text-Medium-14 text-Secondinary-400 lg:text-Medium-16 text-center'>Don’t have an account? <Link href="/signup" className='text-primary-400 text-Semibold-14 hover:text-primary-600'>Register Here</Link></p>
                </div>
